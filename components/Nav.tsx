...
/**
 * De links wijzen bewust naar "/#hoe" en niet naar "#hoe".
 *
 * Een anker zonder slash zoekt op de HUIDIGE pagina. Sta je op een hondpagina,
 * dan bestaat "#hoe" daar niet en gebeurt er niets. Met de slash ervoor ga je
 * eerst naar de homepage en dan naar het juiste blok.
 */
